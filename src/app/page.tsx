            ...
            >
              <div className="max-w-lg mx-auto bg-[#181818] border border-[#333] rounded-lg p-6 sm:p-8">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#e50914]/20 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#e50914]">
                    <circle cx="12" cy="12" r="10"></circle>
                    <line x1="12" y1="8" x2="12" y2="12"></line>
                    <line x1="12" y1="16" x2="12.01" y2="16"></line>
                  </svg>
                </div>
                <h3 className="text-xl font-medium mb-2 text-white">Search Error</h3>
                <p className="text-gray-400 mb-4">{error?.message || "Failed to load movies"}</p>
                <Button
            ...
            >
              ...
              >
                ...
                <div className="flex flex-wrap gap-3 justify-center text-sm text-gray-400">
                  <span className="px-3 py-1 rounded-full border border-[#333] hover:border-gray-400 transition-colors">The Godfather</span>
                  <span className="px-3 py-1 rounded-full border border-[#333] hover:border-gray-400 transition-colors">Inception</span>
                  <span className="px-3 py-1 rounded-full border border-[#333] hover:border-gray-400 transition-colors">Star Wars</span>
                  <span className="px-3 py-1 rounded-full border border-[#333] hover:border-gray-400 transition-colors">Avengers</span>
                </div>
              </motion.div>
            </motion.div>
          )}
