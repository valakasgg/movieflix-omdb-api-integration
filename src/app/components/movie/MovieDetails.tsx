...
import { useAppDispatch, useAppSelector, selectIsInMyList } from "@/app/redux/hooks";
            ...
            >
              ...
              >
                <span className="text-[#46d369] font-medium">
                  {movie.imdbRating !== "N/A" ? `${movie.imdbRating}/10 Match` : "No Rating"}
                </span>
              ...
              >
                <Button 
                  className="bg-white hover:bg-white/90 text-black flex items-center gap-2 px-5 py-1.5 h-auto text-sm md:text-base"
                >
              ...
              >
                ...
                <motion.div variants={fadeIn} className="flex mb-1">
                  <span className="text-gray-400 w-24 flex-shrink-0">Stars:</span>
                ...
                {movie.Awards !== "N/A" && (
                  <motion.div variants={fadeIn} className="flex mb-1 col-span-1 md:col-span-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
          <div className="flex flex-col md:flex-row md:items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-medium">About <span className="text-white">{movie.Title}</span></span>
            </div>
            ...
            {movie.Rated !== "N/A" && (
              <div className="md:ml-auto flex items-center gap-3">
                ...
                <span className="text-xs text-gray-400">
                  Recommended for ages {movie.Rated === "G" ? "All ages" : 
                    movie.Rated === "PG" ? "8+" : 
                    movie.Rated === "PG-13" ? "13+" : 
                    movie.Rated === "R" ? "17+" : 
                    movie.Rated === "NC-17" ? "18+" : "Unknown"}
                </span>
              </div>
            )}
          </div>
